...
int main(int argc, char *argv[])
{
    ...
    // Syncut visual language: restrained desktop chrome, no demo content and no oversized cards.
    app.setStyleSheet(QStringLiteral(R"SYNCUTQSS(
        QMainWindow, QDialog { background: #14181d; color: #e8edf3; }
        QToolBar { background: #171c22; border: 0; border-bottom: 1px solid #2a313a; spacing: 4px; padding: 4px; }
        QToolButton { color: #dfe7ef; background: transparent; border: 1px solid transparent; border-radius: 4px; padding: 5px 7px; }
        QToolButton:hover { background: #202832; border-color: #34404d; }
        QToolButton:checked { background: #17344a; border-color: #2385c7; }
        QMenuBar { background: #12161b; color: #dfe7ef; border-bottom: 1px solid #282f37; }
        QMenuBar::item { padding: 6px 9px; background: transparent; }
        QMenuBar::item:selected { background: #202832; }
        QMenu { background: #171c22; color: #e8edf3; border: 1px solid #303943; }
        QMenu::item:selected { background: #17344a; }
        QLineEdit, QTextEdit, QTextBrowser, QPlainTextEdit, QComboBox, QSpinBox, QDoubleSpinBox {
            background: #11161b; color: #edf3f8; border: 1px solid #333d48; border-radius: 4px; padding: 4px;
        }
        QPushButton { background: #202832; color: #edf3f8; border: 1px solid #35404b; border-radius: 4px; padding: 6px 10px; }
        QPushButton:hover { border-color: #3b9ad8; }
        QPushButton:default { background: #17689b; border-color: #2ba9f2; }
        QTabBar::tab { background: #171c22; color: #aeb9c5; border: 0; border-bottom: 2px solid transparent; padding: 7px 10px; }
        QTabBar::tab:selected { color: #f5f9fc; border-bottom-color: #2ba9f2; }
    ...
    KAboutData aboutData(QByteArray("syncut"), QStringLiteral("Syncut"), KDENLIVE_VERSION,
                         i18n("A professional video editor powered by the Kdenlive/MLT engine."), KAboutLicense::GPL_V3,
                         i18n("Syncut interface © 2026; based on Kdenlive © 2007–2025 Kdenlive authors"), otherText,
